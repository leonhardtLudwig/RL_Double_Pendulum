...
class SimplePendulumEnv(gym.Env):
    ...
    def reset(self, seed=0, state=None, random_init="start_vicinity"):
        """
...
# tuning parameter
n_envs = 10
training_steps = int(1e7)  # default = 1e6
verbose = 1
